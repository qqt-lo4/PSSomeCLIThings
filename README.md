...
### Dialog System
Build interactive CLI dialogs with textboxes, buttons, checkboxes, radio buttons, and more. See the [full Dialog documentation](functions/Dialog/DIALOG.md) for architecture details, component reference, patterns, and examples.
